        ...
        <div className="max-w-4xl mx-auto px-8 py-4">
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex items-center space-x-4 text-gray-600">
              ...
              <a href="https://www.instagram.com/eaglesnest24" className="hover:text-gray-900">
              ...
              <a href="https://www.tripadvisor.com/Restaurant_Review-g298006-d25266639-Reviews-Eagle_s_Nest_Restaurant_Cafe-Izmir_Izmir_Province_Turkish_Aegean_Coast.html" className="hover:text-gray-900">
